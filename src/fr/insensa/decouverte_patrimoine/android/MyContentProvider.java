/*
Utilisé pour lire des ressources dans la bd et les récupérer avec un LoaderManager
Utilisé par exemple par SearchActivity
Voir SearchActivity pour voir comment l'utiliser dans d'autres cas
*/
...
/*
Utilisé pour les recherches de parcours
 */

public class MyContentProvider extends ContentProvider {

  public static final Uri CONTENT_URI = Uri.parse("content://fr.insensa.decouverte_patrimoine.android/elements");
  ...
  static {
   ...
   uriMatcher.addURI("fr.insensa.decouverte_patrimoine.android",
                     "elements", ALLROWS);
   uriMatcher.addURI("fr.insensa.decouverte_patrimoine.android",
                     "elements/#", SINGLE_ROW);
  }
  ...
  // These should be descriptive.
    public static final String KEY_TITRE_PARCOURS = "TITRE_PARCOURS";
    public static final String KEY_LOCALISATION = "LOCALISATION";
    public static final String KEY_DESCRIPTION_PARCOURS = "DESCRIPTION_PARCOURS";
    public static final String KEY_URI_PICTURE = "URI_PICTURE";
    public static final String KEY_ZIP_NAME = "ZIP_NAME";
    public static final String KEY_PARCOURS_IN_LIST = "PARCOURS_IN_LIST";
    public static final String KEY_IS_INSTALLED = "IS_INSTALLED";
    public static final String KEY_NUMERO_PARCOURS = "NUMERO_PARCOURS";
    public static final String KEY_DEPARTEMENT = "DEPARTEMENT";
    public static final String KEY_TEXTE_ARRET_1 = "TEXTE_ARRET_1";
    public static final String KEY_TEXTE_ARRET_2 ="TEXTE_ARRET_2";
    public static final String KEY_TEXTE_ARRET_3 = "TEXTE_ARRET_3";
    public static final String KEY_TEXTE_ARRET_4 = "TEXTE_ARRET_4";
    public static final String KEY_CONSIGNE_ARRET_1 = "CONSIGNE_ARRET_1";
    public static final String KEY_CONSIGNE_ARRET_2 = "CONSIGNE_ARRET_2";
    public static final String KEY_CONSIGNE_ARRET_3 = "CONSIGNE_ARRET_3";
    public static final String KEY_CONSIGNE_ARRET_4 = "CONSIGNE_ARRET_4";
  ...
  public boolean onCreate() {
      System.out.println("jerome : onCreate MyContentProvider");
